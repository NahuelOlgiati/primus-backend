...
//		{
//			throw new ManagerException(DBSMsgHandler.getMsg(BaseUserManagerEJB.class, "emptyBasicProfile"));
//		}
//
...
//		userML.validUserNameDuplication(model);
	...
	protected void doBeforeDelete(T model) throws BaseException
	{
		...
		{
//			throw new ValidationException(DBSMsgHandler.getMsg(BaseUserManagerEJB.class, "canNotDeleteUserName"));
		}
	}
...
//			if (excludeReserved)
//			{
//				predicateList.add(cb.not(pb.in(userName, UserReservedEnum.getNames())));
//			}
...
//			cq.orderBy(orderList);
	...
	public void validSystemAgentDuplication(final Document d) throws ManagerException
	{
		...
		{
//			throw new ManagerException(DBSMsgHandler.getMsg(BaseUserManagerEJB.class, "systemAgentDuplicatedException"));
		}
	}
}